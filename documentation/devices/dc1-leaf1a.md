...
| Ethernet5 | SERVER_dc1-leaf1-server1_VPC7 | access | 11 | - | - | - |
| Ethernet6 | SERVER_dc1-leaf1-server1_PCI1 | *trunk | *11-12,21-22 | *4092 | *- | 6 |
...
!
interface Ethernet5
   description SERVER_dc1-leaf1-server1_VPC7
   no shutdown
...
| Port-Channel6 | SERVER_dc1-leaf1-server1_Bond1 | trunk | 11-12,21-22 | 4092 | - | - | - | 6 | - |
