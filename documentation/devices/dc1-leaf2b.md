...
| Ethernet5 | SERVER_dc1-leaf2-server1_VPC10 | access | 12 | - | - | - |
| Ethernet6 | SERVER_dc1-leaf2-server1_PCI2 | *trunk | *11-12,21-22 | *4092 | *- | 6 |
...
!
interface Ethernet5
   description SERVER_dc1-leaf2-server1_VPC10
   no shutdown
